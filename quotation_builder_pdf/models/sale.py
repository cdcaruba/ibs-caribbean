...
class SaleOrder(models.Model):
    ...
    x_txt_website_description = fields.Html('Text Website Description', compute='_compute_sanitize_html',
                                            sanitize_attributes=False)

    @api.depends('website_description')
    def _compute_sanitize_html(self):
        for record in self:
            record.x_txt_website_description = _sanitize_html(record.website_description)
